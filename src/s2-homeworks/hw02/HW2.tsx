...
export const filterAffairs = (affairs: Array<AffairType>, filter: FilterType): AffairType[] => { // need to fix any
    let affairsNew = affairs
    if (filter === 'low') {
        affairsNew = affairs.filter(e => e.priority === 'low')
    }
    if (filter === 'middle') {
        affairsNew = affairs.filter(e => e.priority === 'middle')
    }
    if (filter === 'high') {
        affairsNew = affairs.filter(e => e.priority === 'high')
    }
    return  affairsNew // need to fix
}
